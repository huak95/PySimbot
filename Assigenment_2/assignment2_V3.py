...
class MyRobot(Robot):
    ...
    def update(self):
        ...
        # back sensor
        rules.append(self.near_ir(3) * self.mid_ir(4) * self.mid_ir(5) * self.far_ir(0))
        moves.append(3)
        turns.append(0)
        ...
        # rules.append(self.near_ir(0) * self.near_ir(-1) * self.far_ir(1))
        # moves.append(-30)
        # turns.append(-90)
